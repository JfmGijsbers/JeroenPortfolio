...
<nav class="bg-white dark:bg-gray-700 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark sticky top-0 z-10">
  ...
  <div class="flex md:order-2 justify-end">
        ...
        <a href="/CV___Jeroen_Gijsbers.pdf" class="hidden md:block text-white bg-blue-700 dark:bg- hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            <Document/>
        </a>
